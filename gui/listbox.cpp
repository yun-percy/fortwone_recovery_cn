...
GUIListBox::GUIListBox(xml_node<>* node)
{
	...
	mUpdate = 0;
	touchDebounce = 6;
	ConvertStrToColor("white", &mBackgroundColor);
	ConvertStrToColor("white", &mHeaderBackgroundColor);
	ConvertStrToColor("white", &mSeparatorColor);
	ConvertStrToColor("white", &mHeaderSeparatorColor);
	ConvertStrToColor("black", &mFontColor);
	ConvertStrToColor("black", &mHeaderFontColor);
	ConvertStrToColor("black", &mFastScrollLineColor);
	ConvertStrToColor("black", &mFastScrollRectColor);
